...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 22 2023 г., 15:28
...
(7, '<img class="dd" src="data:image/gif;base64,">\r\n', 'manky'),
...
CREATE TABLE IF NOT EXISTS `numr` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nom` varchar(255) NOT NULL,
